 ...
 *
 */
public class ThreeApproximationOutputFile {

	public static void main(String[] args) throws IOException {

		List<String> list = new ArrayList<String>();
		ClassLoader classLoader = ThreeApproximationOutputFile.class.getClassLoader();
	...
	private static void writeToFile(StringBuffer sb) throws IOException {
		File file = new File("three_approx_report.txt");
